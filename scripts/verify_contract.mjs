...
const routes = ["/", "/explore", "/research", "/learn", "/library", "/login", "/search", "/persiapan", "/persiapan/tka-sma-smk/matematika", "/persiapan/tka-sma-smk/matematika/latihan", "/persiapan/tryout", "/persiapan/progress"];
const apis = ["/api/health", "/api/readyz", "/api/providers", "/api/education/taxonomy", "/api/preparation/catalog", "/api/preparation/practice?program=tka-sma-smk&subject=matematika&limit=5", "/api/preparation/tryouts", "/api/preparation/recommendations"];
